...
core_foundation::declare_TCFType!(
    #[doc = "Represents a network interface."]
    #[doc = ""]
    #[doc = "See [`SCNetworkInterfaceRef`] and it's [methods] for details."]
    #[doc = ""]
    #[doc = "[`SCNetworkInterfaceRef`]: https://developer.apple.com/documentation/systemconfiguration/scnetworkinterfaceref?language=objc"]
    #[doc = "[methods]: https://developer.apple.com/documentation/systemconfiguration/scnetworkconfiguration?language=objc"]
    NetworkInterface,
