...
core_foundation::declare_TCFType!(
    #[doc = "A network address or host for which the connectivity can be determined."]
    #[doc = ""]
...
impl NetworkReachability {
    ...
    pub fn set_callback<F: FnMut(ReachabilityFlags) + Clone>(
        &mut self,
        callback: F,
