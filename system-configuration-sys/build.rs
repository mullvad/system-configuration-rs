...
fn main() {
    ...
    let system_configuration_header_path = format!("{}/SystemConfiguration.framework/Headers/", framework_path);

    let _ = bindgen::builder()
        .header(format!("{}/SCDynamicStore.h", system_configuration_header_path))
